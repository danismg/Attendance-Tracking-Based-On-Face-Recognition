...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1 = tk.Button(self, text="   Add a User  ",
                                fg="#ffffff",
                                bg="#263942",
                                command=lambda: self.controller.show_frame("PageOne"))
            
            button2 = tk.Button(self, text="   Check a User  ",
                                fg="#ffffff",
                                bg="#263942", 
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter the name",
                 fg="#263942",
        ...
        self.user_name = tk.Entry(self, borderwidth=3, 
                                  bg="lightgrey",
                                  font='Helvetica 11')
        ...
        self.buttonext = tk.Button(self, text="Next",
                                   fg="#ffffff",
                                   bg="#263942",
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        global names
        self.controller = controller
        tk.Label(self, text="Select user",
                 fg="#263942",
                 font='Helvetica 12 bold').grid(row=0,
                                                column=0,
                                                padx=10,
        ...
        self.buttonext = tk.Button(self, text="Next",
                                   command=self.nextfoo,
                                   fg="#ffffff",
                                   bg="#263942")

        self  .dropdown.grid(row=0, column=1, ipadx=8, padx=10,  pady=10)
        self.buttoncanc.grid(row=1, column=0, ipadx=5, ipady=4,  pady=10)
        self .buttonext.grid(row=1, column=1, ipadx=5, ipady=4,  pady=10)
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        self.numimglabel = tk.Label(self, fg="#263942",
                                    text="Number of images captured = 0",
                                    font='Helvetica 12 bold')

        self.numimglabel.grid(row=0, column=0, pady=10,
                              columnspan=2, sticky="ew")

        self.capturebutton = tk.Button(self, text="Capture Data Set",
                                       fg="#ffffff",
                                       bg="#263942",
                                       command=self.capimg)

        self.trainbutton = tk.Button(self, text="Train The Model",
                                     fg="#ffffff",
                                     bg="#263942",
